...
if 'JSROOTSYS' in os.environ:
    ...
    c.NotebookApp.extra_static_paths.append(os.path.join("/home/sftnight/build/ws/BUILDTYPE/Release/LABEL/ROOT-ubuntu2004/V/6-24/install/ROOT", "js"))
    c.ServerApp.extra_static_paths.append(os.path.join("/home/sftnight/build/ws/BUILDTYPE/Release/LABEL/ROOT-ubuntu2004/V/6-24/install/ROOT", "js"))
