...
TH2D* get_efficiency_TH2DJpsi(TH2D* hall, TH2D* hpass, string xquantity, string yquantity, string MuonId, string prefix_name = "")
{
	...
	if (should_save)
	{
	string output_folder_name = "results/efficiencies/systematic_2D/Jpsi";
	//string output_folder_name = "results/efficiencies/systematic_2D/Jpsi_MC";
